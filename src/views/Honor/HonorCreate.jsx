...
import { honorCreateAPI } from "../../utils/api"
...
class HonorCreate extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      detail: "",
  ...
  handleSubmit = async () => {
    if (this.isValidated()) {
      ...
      await honorCreateAPI({ intro, detail, time, type });
          ...
          <Card>
            <CardHeader color="primary" text>
              <CardText color="primary">
                <h4 className={classes.cardTitle}>新建故事</h4>
              </CardText>
            </CardHeader>
            <CardBody>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withStyles(regularFormsStyle)(HonorCreate)));
